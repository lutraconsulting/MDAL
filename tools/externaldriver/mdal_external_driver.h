...
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_driverName();

//! Returns the driver name
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_driverLongName();

//! Returns the driver suffix files filters
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_filters();

//! Returns the driver capability flags
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_capabilities();

//! Returns the driver capability flags
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_maxVertexPerFace();

//! Returns whether the driver can read the file
MDAL_LIB_EXPORT bool CALL_CONV MDAL_DRIVER_canReadMesh( const char * );

//! Opens  mesh and return the id of the mesh. This id is used to access to the mesh latter.
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_openMesh( const char *uri, const char *name );

//! Closes the mesh
MDAL_LIB_EXPORT void CALL_CONV MDAL_DRIVER_closeMesh( int meshId );

//! Returns the vertices count
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_vertexCount( int meshId );

//! Returns the faces count
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_faceCount( int meshId );

//! Returns the edges count
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_edgeCount( int meshId );

/**
 * Returns mesh extent in native projection
 */
MDAL_LIB_EXPORT void CALL_CONV MDAL_DRIVER_M_extent( int meshId, double *xMin, double *xMax, double *yMin, double *yMax );

/**
 * Returns mesh projection
 */
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_M_projection( int meshId );
 ...
 */
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_vertices( int meshId, int startIndex, int count, double *buffer );
 ...
 */
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_faces( int meshId, int startFaceIndex, int faceCount, int *faceOffsetsBuffer, int vertexIndicesBufferLen, int *vertexIndicesBufer );
 ...
 * \since MDAL 0.6.0
 */
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_edges( int meshId, int startEdgeIndex, int edgeCount, int *startVertexIndices, int *endVertexIndices );

//! Returns the the dataset group count for the mesh with id \a meshId
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_M_datasetGroupCount( int meshId );

//! Returns the name of the group with index \a groupIndex of the mesh with id \a meshId
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_G_groupName( int meshId, int groupIndex );

//! Returns the reference time (ISO 8601) of the group with index \a groupIndex of the mesh with id \a meshId
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_G_referenceTime( int meshId, int groupIndex );

//! Returns the metadata count for the dataset group
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_G_metadataCount( int meshId, int groupIndex );

//! Returns the metadata key
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_G_metadataKey( int meshId, int groupIndex, int metaDataIndex );

//! Returns the metadata value
MDAL_LIB_EXPORT const char *CALL_CONV MDAL_DRIVER_G_metadataValue( int meshId, int groupIndex, int metaDataIndex );

//! Returns dataset description, that is attributes that define the data
MDAL_LIB_EXPORT bool CALL_CONV MDAL_DRIVER_G_datasetsDescription( int meshId, int groupIndex, bool *isScalar, int *dataLocation, int *datasetCount );

//! Returns the dataset value, for value on vector, the buffer contains \a count pair of values : x0,y0,
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_D_data( int meshId, int groupIndex, int datasetIndex, int indexStart, int count, double *buffer );

//! Returns whether the dataset has active flag capability
MDAL_LIB_EXPORT bool CALL_CONV MDAL_DRIVER_D_hasActiveFlagCapability( int meshId, int groupIndex, int datasetIndex );

//! Returns the dataset active flags
MDAL_LIB_EXPORT int CALL_CONV MDAL_DRIVER_D_activeFlags( int meshId, int groupIndex, int datasetIndex, int indexStart, int count, int *buffer );
